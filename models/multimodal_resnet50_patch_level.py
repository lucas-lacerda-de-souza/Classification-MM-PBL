"""
Multimodal ResNet50 Classifier for MM and PBL
------------------------------------------------------
Author: Lucas Lacerda de Souza

Description:
    This script implements a multimodal deep learning pipeline that integrates histopathological image patches, clinicopathologic and nuclear morphometric 
    features to classify plasma cell lesions into Multiple Myeloma (MM – Class 1) and Plasmablastic Lymphoma (PBL – Class 2).

    The model is based on a ResNet50 convolutional backbone for image embeddings, combined with a fully-connected network for clinical and nuclear morphometric data.
    The network is trained and validated on labeled patch-level data, and evaluated on an external test set using standard classification metrics and explainable outputs.
...
# ===============================================================
# Model Definition (ResNet50 + Clinical Data)
# ===============================================================
...
def main():
    ...
    val_dir = "data/val"
    test_dir = "data/test"
    results_dir = "results/multimodal_resnet50"
    ...
    # Model
    # ------------------------------
    model = MultimodalResNet50(clinical_input_dim, num_classes=2)
