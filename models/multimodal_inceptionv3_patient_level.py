"""
Multimodal InceptionV3 Classifier for MM and PBL
-------------------------------------------------------------------------------------------
Author: Lucas Lacerda de Souza

Description:
    This script implements a multimodal deep learning pipeline that integrates histopathological image patches, clinicopathologic and nuclear 
    morphometric features to classify plasma cell lesions into Multiple Myeloma (MM – Class 1) and Plasmablastic Lymphoma (PBL – Class 2).

    The model uses InceptionV3 for feature extraction from image patches, combines it with a clinical/nuclear feature MLP, and evaluates at both 
    patch-level and patient-level using ROC AUC, calibration curves, confusion matrices, and bootstrapped confidence intervals.
...
# ===============================================================
# Multimodal InceptionV3 Model  ← ONLY CHANGE
# ===============================================================
class MultimodalInceptionV3(nn.Module):
...
# ===============================================================
# Patient-Level Evaluation and Visualization (UNCHANGED)
# ===============================================================
...
def main():
    ...
    val_dir = "data/val"
    test_dir = "data/test"
    results_dir = "results/inceptionv3_multimodal"
    ...
    transform = transforms.Compose([
        transforms.Resize((299, 299)),  # InceptionV3 native input size
        transforms.ToTensor(),
    ...
    model = MultimodalInceptionV3(clinical_input_dim)
    ...
    print(
        ...
        f"(95% CI: {metrics['auc_ci_low']:.3f} – {metrics['auc_ci_high']:.3f})"
    )
