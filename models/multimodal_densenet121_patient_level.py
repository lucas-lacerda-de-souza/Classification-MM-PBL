...
Description:
    ...
    The model uses DenseNet121 for feature extraction from image patches, combines it with a clinical/nuclear feature MLP, and evaluates at both patch-level and patient-level 
...
def main():
    ...
    test_dir = "data/test"
    results_dir = "results/densenet121_multimodal"
    ...
    model = MultimodalDenseNet121(clinical_input_dim)
