"""
Multimodal InceptionV3 Classifier for DLBCL and ENKTCL-NT
--------------------------------------------------------
...
Description:
    ...
    The model is based on an InceptionV3 convolutional backbone for image embeddings, combined with a fully-connected network for clinical and nuclear morphometric data.
...
# ===============================================================
# Model Definition (InceptionV3 + Clinical Data)
# ===============================================================
class MultimodalInceptionV3(nn.Module):
    def __init__(self, clinical_input_dim, num_classes=2):
        super().__init__()

        # Load InceptionV3 backbone (no auxiliary output)
...
def main():
    ...
    val_dir = "data/val"
    test_dir = "data/test"
    results_dir = "results/multimodal_inceptionv3"
    ...
    transform = transforms.Compose([
        transforms.Resize((299, 299)),  # InceptionV3 native resolution
        transforms.ToTensor(),
    ...
    # Model
    # ------------------------------
    model = MultimodalInceptionV3(clinical_input_dim, num_classes=2)
