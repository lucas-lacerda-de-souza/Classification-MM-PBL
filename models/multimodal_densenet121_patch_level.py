"""
Multimodal DenseNet121 Classifier for MM and PBL
--------------------------------------------------------
...
Description:
    ...
    to classify lymphoid lesions into Multiple Myeloma (MM – Class 1) and Plasmablastic Lymphoma (PBL – Class 2).

    The model is based on a DenseNet121 convolutional backbone for image embeddings, combined with a fully-connected network for clinical and nuclear morphometric data.
...
# ===============================================================
# Model Definition (DenseNet121 + Clinical Data)
# ===============================================================
...
def main():
    ...
    val_dir = "data/val"
    test_dir = "data/test"
    results_dir = "results/multimodal_densenet121"
    ...
    # Model
    # ------------------------------
    model = MultimodalDenseNet121(clinical_input_dim, num_classes=2)
