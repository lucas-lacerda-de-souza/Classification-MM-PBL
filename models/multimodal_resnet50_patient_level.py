...
Description:
    ...
    The model uses ResNet50 for feature extraction from image patches, combines it with a clinical/nuclear feature MLP, and evaluates at both patch-level and patient-level 
...
# Multimodal ResNet50 Model  ← ONLY THIS PART WAS CHANGED
...
def main():
    ...
    val_dir = "data/val"
    test_dir = "data/test"
    results_dir = "results/resnet50_multimodal"
    ...
    model = MultimodalResNet50(clinical_input_dim)  # ← UPDATED HERE
