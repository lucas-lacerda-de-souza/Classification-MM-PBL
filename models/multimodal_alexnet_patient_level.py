...
Description:
    ...
    patch-level and patient-level classification.

    Model performance is evaluated using ROC AUC, confusion matrices, calibration curves, and bootstrapped confidence intervals. The pipeline 
    follows patient-level data separation to prevent data leakage and supports internal and external validation cohorts.
...
# ---------------------------------------------------------------------------
# Multimodal AlexNet Model Definition
# ---------------------------------------------------------------------------
class MultimodalAlexNet(nn.Module):
    def __init__(self, clinical_input_dim, num_classes=2):
        ...
        self.backbone_feature_dim = 256 * 6 * 6  # feature map size from AlexNet
        ...
        # Classifier combining image + clinical features
...
def main():
    ...
    val_dir = "data/val"
    test_dir = "data/test"
    results_dir = "results/alexnet_multimodal"
    ...
    model = MultimodalAlexNet(clinical_input_dim)
